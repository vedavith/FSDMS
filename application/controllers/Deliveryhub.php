		...
		if ($this->form_validation->run())
		{
			...
			if($data['count'])
			{
				if($this->session->has_userdata('admin_id'))
				{
					...
					// $this->load->view('headers/footer'); 
          redirect(base_url()."deliveryhub/deliveryhub_home");
				}
				else
				{
					$this->error_403();
...
//-------------------------------------end---------------------------------
  ...
  // -----------------------Receiving Orders ----------------------------
    //16-05-19
    public function order_products_kitchen()
    {
      if($this->session->has_userdata('admin_id'))
        {
            $data['user_data'] = $this->select_model->select_user($this->backend_table,$this->user_id);
          ...
          $this->load->view('headers/deliveryhub_home_header',$data);
          $this->load->view('deliveryhub/delivery_product_data',$data);
          $this->load->view('headers/footer');
    ...
    public function fetch_kitchen_product()
    {
      $result_data = $this->select_model->fetch_product_orders($this->input->post('kit_id'),$this->input->post('date_val'));
  ...
  //------------------------end receiving Orders ----------------------------
  //----------------------current date orders -------------------------------
    public function receiving_orders_data()
    {
      if($this->session->has_userdata('admin_id'))
        {
            $data['user_data'] = $this->select_model->select_user($this->backend_table,$this->user_id);
           $data['kitchen_data'] = $this->select_model->select_kitchen_current_data(); 
             
          $this->load->view('headers/deliveryhub_home_header',$data);
          $this->load->view('deliveryhub/kitchen_product_data',$data);
          $this->load->view('headers/footer');
  ...
  //------------------------------------------------------------------------
   //----------------------Assigning Delivery boys-------------------------------
    public function assigning_delivery_executives()
    {
      if($this->session->has_userdata('admin_id'))
        {
            $data['user_data'] = $this->select_model->select_user($this->backend_table,$this->user_id);
          ...
          $this->load->view('headers/deliveryhub_home_header',$data);
          $this->load->view('deliveryhub/del_order_assigned_executive',$data);
          $this->load->view('headers/footer');
  ...
  //-----------------------ORDER LIST ---------------------------------------
    ...
    {
      $data = file_get_contents(base_url()."json/order_list.json");
    ...
    //29-05-19
    public function delivery_assigning()
    {
      if($this->session->has_userdata('admin_id'))
        {
            $data['user_data'] = $this->select_model->select_user($this->backend_table,$this->user_id);
           $data['prod_sku'] = $this->select_model->select_product_master(1);
            $data['del_exe'] = $this->select_model->delivery_exe();  
            $data['current_order_list'] = $this->order_list();
          $this->load->view('headers/deliveryhub_home_header',$data);
          $this->load->view('deliveryhub/delivery_assign',$data);
          $this->load->view('headers/footer');
  ...
  //-------------------------------------------------------------------------
    ...
    //--------------------- Total Orders List ------------------------------
    public function delivert_orders_count()
    {
      if($this->session->has_userdata('admin_id'))
        {
            $data['user_data'] = $this->select_model->select_user($this->backend_table,$this->user_id);
