 ...
 <div class="col-sm-6 col-md-9">
    <div class="row">
        ...
        <div class="col-md-3" align="right">
            <a class="btn btn-sm btn-primary" href="<?php echo base_url()."deliveryhub/view_employee"; ?>"> Manage </a>
        </div>
        <div class="col-md-3" align="right">
...
<div class="col-md-2">
    ...
    <div class = "col-md-11 container">
        ...
        <div class="row"> 
            ...
            <div class="col-md-3">
                ...
                <select name ="txtdelhub_id" class="form-control">
                    <option value="">Select delivery hub Id</option>
                    <?php
                    foreach($delhub_id->result() as $de)
                    {
                    ?>
                    <option value="<?php echo $de->delhub_id ?>"> <?php echo $de->delhub_name;?></option>
                    <?php
                    }
                    ?>
                </select>
            ...
            <div class="col-md-3">
				...
				<!-- <input type="text" class="form-control" name="emp_role" placeholder="" value="" > -->
                 <select name="txtemp_role" class="form-control">
                   ...
                   <?php
                    foreach($delhub_role->result() as $der)
                    {
                    ?>
                    <option value="<?php echo $der->id ?>"> <?php echo $der->role_name;?></option>
                    <?php
                    }
                    ?>
                </select>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="txtlicence" value=""/>
                        </div>
                        <div class="col-md-3">
                            <label>Vehicle No. </label>
                            <input type="text" class="form-control" name="txtvehicle" value=""/>
                        </div>
                    </div>
                    <br/>
                        <div class="row">
    ...
    $count=0;
            ...
            ?>
            <?php
                if(!empty(form_error("txtlicence")))
                {
                $count = 1;
            ?>
                <div class="row alert alert-danger">
                    <strong>REQUIRED** : </strong> Licence No. is Required
                </div>
            <?php
                }
            ?>
            <?php
                if(!empty(form_error("txtvehicle")))
                {
                $count = 1;
            ?>
                <div class="row alert alert-danger">
                    <strong>REQUIRED** : </strong> Vehicle No. is Required
                </div>
            <?php
                }
            ?>
...
<div class="col-md-2">
    ...
    <div class = "col-md-11 container">
        ...
        <div class="row"> 
            ...
            <div class="col-md-3">
                <label>Employee Id</label>
                <input type="text" name="txtemp_id" class="form-control" placeholder="" value="<?php echo  $kitchen->emp_id;?>" readonly>
            </div>
            <div class="col-md-3">
                <label> First Name</label>
            ...
            <div class="col-md-3">
                ...
                <!-- <input type="text" class="form-control" name="emp_role" placeholder="" value="" > -->
                   ...
                   <?php
                    ...
                    {
                    ?>
                    <option value="<?php echo $der->id ?>" <?php if($kitchen->emp_role == $der->id){echo "selected='selected'";}?>> <?php echo $der->role_name;?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="col-md-3">
                            <label>Licence No. </label>
                            <input type="text" class="form-control" name="txtlicence" value="<?php echo $kitchen->lic_no; ?>"/>
                        </div>
                        <div class="col-md-3">
                            <label>Vehicle No. </label>
                            <input type="text" class="form-control" name="txtvehicle" value="<?php echo $kitchen->vehicle_no; ?>"/>
                        </div>
                    </div>
                    <br>
                        <div class="row">
