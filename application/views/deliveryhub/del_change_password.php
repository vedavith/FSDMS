<?php 
if($delivery_user_data->num_rows() >= 0)
{
	foreach($delivery_user_data->result() as $kitchen_admin)
	{
?>            
<section>
<div class="col-md-2">
    ...
    <div class = "col-md-9 container">
        <div class="card bg-light text-dark">
            ...
            <p class = "h3">Change Password</p>
                <br>
        <form method="post" action="<?php echo base_url()."deliveryhub/edit_profile_data" ?>">
        <div class="row">    
            <div class="col-md-8">
				<input type="hidden" name="delivery_id" class="form-control" placeholder="Kitchen ID" value="<?php echo  $kitchen_admin->delhub_id;?>" readonly>

            	<label> Current Password</label>
				<input type="hidden" class="form-control" name="curr_pass" id="password" placeholder="Current Password" value="<?php echo  $kitchen_admin->password;?>">
    ...
    <br><br>
        ...
        <div class="col-md-3"></div>
			...
			<a href="<?php echo base_url()."deliveryhub/deliveryhub_home"; ?>" class="btn btn-outline-danger" >Cancel</a>
