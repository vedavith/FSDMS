...
<section>
    <div class = "container">
                ...
                <br>
        <form method="post" action="<?php echo base_url()."deliveryhub/edit_user_data" ?>">
        <div class="row">
            <div class="col-md-3">
            <label>Deliveryhub ID</label>
				...
				<input type="text" name="delivery_id" class="form-control" placeholder="Deliveryhub ID" value="<?php echo  $kitchen_admin->delhub_id;?>" readonly>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<!-- <div class="col-md-3">
				...
				<input type="text" class="form-control" name="renew_pass" placeholder="Username" value="<?php echo  $kitchen_admin->password;?>">
			</div> -->
