...
<div class="col-md-2">
    ...
    <div class = "col-md-9 container">
        <div class="card bg-light text-dark">
            ...
            <p class = "h3">Change Password</p>
                <br>
        <form method="post" action="<?php echo base_url()."kitchen/edit_profile_data" ?>">
        <div class="row">    
            <div class="col-md-8">
				<input type="hidden" name="kitchen_id" class="form-control" placeholder="Kitchen ID" value="<?php echo  $kitchen_admin->kitchen_id;?>" readonly>
    ...
    <br><br>
        ...
        <div class="col-md-3"></div>
			...
			<a href="<?php echo base_url()."kitchen/kitchen_home"; ?>" class="btn btn-outline-danger" >Cancel</a>
