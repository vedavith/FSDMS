      ...
      <tbody align="center">
        <?php
          ...
          <tr>
            ...
            <td> <a class="btn btn-sm btn-primary" href="<?php echo base_url()."superadmin/edit_branch/".$branch->id; ?>"> Edit </a> </td>
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".delete_category").click(function(){
			...
			{
				window.location="<?php echo base_url();?>superadmin/delete_corp_branch/"+id;
			}
			else
			{
				return false;
