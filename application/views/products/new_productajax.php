		        	...
		        	<div class="card-body row hide">
		        		...
		        		<div class="col-md-3">
		        			<div class="card-body">
			        			...
			        			<select name="prddata" class="form-control" id="prddata" >
		        		...
		        		<div class="col-md-3">
		        			<div class="card-body">
		        			<!--<input type="text" id="product_name" name="customizable_options[]" class="form-control" placeholder="Product Name"> -->
		        			<select name="prdpricedata" class="form-control" id="prdpricedata">
								<option> </option>
				          	</select>
				          </div>
		        		...
		        		<div class="col-md-3">
			        		<div class="card-body">
								<div class="col-md-1 col-sm-12">
									<input type="button" class="btn btn-sm btn-outline-danger" id = "addCFE" value="Add"  />
								</div>
							</div>
						</div>
		        		<!--<div class="col-md-3">
...
<!--         	<script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js"></script>
 -->
			...
			$(document).ready(function(){
				var i=1;
				$("#addCFE").click(function(){
					alert(i);
					alert("add");
					var data='<div class="row"><div class="col-xs-12 col-sm-6 col-md-3"><div class="form-group"><p>Product Details<select name="prddata[]" id="prddata" class="form-control input-lg"  onchange=prdchange(); tabindex="2" placeholder="Select Product"><option value=""> Select Product </option><?php 
						foreach($prd_data->result() as $row){ $id=$row->id;$sku=$row->product_sku;	$prdname=$row->product_name;
							$prskuid= $id."_".$sku."_".$prdname;  ?><option value="<?php echo $prskuid; ?>"> <?php echo $row->product_name ?> </option><?php } ?></select></p> </div></div><div class="col-xs-6 col-sm-3 col-md-2"><div class="form-group"><p>GST% <select name="prdpricedata[]" id="prdpricedata" class="form-control input-lg"  tabindex="2" placeholder="Select Product Price"></select> </p></div></div> <div class="col-md-1 col-sm-12"> <input type="button" class="btn btn-sm btn-outline-danger" id = "remCF" value="Remove"  /></div> </div>';
					$("#customopt").append(data);
					i++;
				});
			    $("#customopt").on('click','#remCF',function(){
			    	alert("remove");
