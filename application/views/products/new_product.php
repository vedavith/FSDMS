...
<!--       	<div class="row">
    ...
    <div class="card">
      ...
      <div id="CategoryTwo" class="collapse" data-parent="#accordion1">
    	...
    	<div class="row">
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Product GST </label> </div>
        	<div class="card-body col-md-6" align="left">
        		<input type="text" name="product_gst" id="product_gst" class="form-control" placeholder="Product GST">
        	</div>
    	</div>
    	<div class="row">
        	...
        	<div class="card-body col-md-6" align="left">
        		<input type="number" name="product_price" id="product_price" class="form-control" placeholder="Product Price" min="0">
        	</div>
    	</div>
    	<div class="row">
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Product Sub total </label> </div>
        	<div class="card-body col-md-6" align="left">
        		<input type="text" name="product_total" id="product_total" class="form-control" placeholder="Product Sub total" min="0" readonly>
        	</div>
    	</div>
    	<div class="row">
    		...
    		<div id="customopt">    			
                ...
                <div v-for="(product,index) in productArray">
		        	<div class="card-body row hide">
		        		...
		        		<div class="col-md-3">
		        			<div class="card-body">		        		
			        			<input type="text" id="prdgst" name="customizable_gst[]"   v-model="product.prdgst" class="form-control" placeholder="productgst" readonly> 				      
		        			</div>
		        		</div>
		        		<div class="col-md-3">
		        			<div class="card-body">		        		
			        			<input type="text" id="prdtotal" name="customizable_subtotal[]"   v-model="product.prdsubttl" class="form-control" placeholder="product subtotal" readonly> 				      
		        			</div>
		        		</div>
		        		<div class="col-md-3">
		        			<div class="card-body">
			        			...
			        			<input type="text" id="prdprice" name="customizable_price[]"   v-model="product.prdpricedata" class="form-control" placeholder="price" readonly>	
			   ...
			   deleteRow(index) {
			    ...
			    getPrice(index){
			    	...
			    	if(productDetail)                
			    		...
			    		rowData.prdgst= productDetail.product_gst; 
			    		rowData.prdsubttl= productDetail.product_sub_total;                    
    ...
    <div class="card">
      ...
      <div id="CategoryTwo" class="collapse" data-parent="#accordion1">
    	...
    	<div class="row">
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Product GST </label> </div>
        	<div class="card-body col-md-6" align="left">
        		<input type="text" name="product_gst" id="product_gst" class="form-control" placeholder="Product GST" value="<?php echo $row->progst; ?>">
        	</div>
    	</div>
    	<div class="row">
    	...
    	<div class="row">
        	...
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Product Price </label> </div>
        	<div class="card-body col-md-6" align="left">
        		<input type="number" name="product_price" id="product_price" class="form-control" placeholder="Product Price" min="0" value="<?php echo $row->price; ?>">
        	</div>
    	</div>
    	<div class="row">
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Product Sub total </label> </div>
        	<div class="card-body col-md-6" align="left">
        		<input type="text" name="product_total" id="product_total" class="form-control" placeholder="Product Sub total" readonly value="<?php echo $row->subttl; ?>">
        	</div>
    	</div>
    	<div class="row">
        	<div class="card-body col-md-3" align="right"> <label class="h6"> Is Customizable </label> </div>
...
console.log(prices);
var names = custom_det.customizable_sku.split(",");
console.log(names);
var gst = custom_det.custom_product_gst.split(",");
console.log(gst);
var subttl = custom_det.custom_product_subtotal.split(",");
console.log(subttl);

ids.forEach((id,index) => {
var prd = new prdDetail();
var productDetail = producttable.find(e=> e.product_sku == id); 
prd.prddata = names[index];
prd.prdsku = names[index];
prd.prdname = ids[index];
prd.prdpricedata=prices[index];
prd.prdgst = gst[index];
prd.prdsubttl = subttl[index];
...
<script>
    		...
    		// {
    			$('#product_price').change(function()
    			{
    				var total ='';
    				var price = $(this).val();
    				var percentage = $('#product_gst').val();
    				total = parseFloat(price) + (parseFloat(price) * (parseFloat(percentage)/100));
    				alert(total);
