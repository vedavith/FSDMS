...
<div id="accordion">
      ...
      <div id="collapseFour" class="collapse show" data-parent="#accordion">
            ...
            <!-- <a href="#" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
               ...
               <a href="<?php echo base_url()."kitchen/get_assigned_orders"?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div class="d-flex w-100 justify-content-start align-items-center">
                         <li class="fas fa-fw mr-3 fa-tasks text-light"></li> 
                         <span class="menu-collapsed text-light">Assigned Products</span>
    ...
    <div class="card bg-secondary">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
                 ...
                 <a href="<?php echo base_url()."kitchen/assigned_orders" ?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Prepared Orders</span>
                </a>

                <!-- <a href="<?php //echo base_url()."kitchen/kitchen_delivery_report" ?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Product Report</span>
                </a> -->
                <!--  <a href="<?php //echo base_url()."kitchen/kitchen_delivery_order" ?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed"> Delivery Order </span>
                </a>
                <a href="<?php //echo base_url()."kitchen/delivery_challan_order" ?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">  Order Delivery Challan </span>
                </a> -->
     ...
     <div class="card bg-secondary">
      ...
      <div id="collapseThree" class="collapse" data-parent="#accordion">
                    ...
                    <div class="d-flex w-100 justify-content-start align-items-center">
                         ...
                         <span class="menu-collapsed text-light"> Messages <span class="badge badge-pill badge-primary ml-2">
                          <?php 
                         echo $notify_cnt;
                          ?>
                         </span></span>
               ...
               <a href="<?php echo base_url()."kitchen/create_kitchen_notification" ?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed"> Send</span>
                </a>
               
                <a href="<?php echo base_url()."kitchen/view_kitchen_data" ?>" class="list-group-item list-group-item-action bg-dark text-white">
