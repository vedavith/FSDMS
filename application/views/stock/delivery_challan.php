  ...
  <div class="container" id="accordion1">
    <div class="card">
      ...
      <div id="CategoryOne" class="collapse show" data-parent="#accordion1">
            ...
            <div class="row">
                <div class="card-body col-md-3" align="right">
                    <label class="h6"> Delivery Executive </label>
                </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            <select class="form-control" name="delivery_user" id="kit_id">
                                ...
                                <?php
                                    foreach($del_exe->result() as $rowex)
                                    {
                                ?>
                                    <option value="<?php echo $rowex->id; ?>"> <?php echo $rowex->emp_name; ?> </option>
                                <?php        
                                    }
                                ?>  
        	...
        	<div class="row">
	      		<div class="card-body col-md-3" align="right">
      				...
      				<div class="col-md-6">
						...
						?>
            <option data-value="<?php echo $row->product_sku."%".$row->primary_units."%".$row->store_name."%".$row->room_name.'-'.$row->grid_name.'-'.$row->bin_name."%".$row->quantity."%".$row->grid_add;?>" value="<?php echo $row->product_name; ?>"> <?php echo $row->product_name.'-'.$row->product_sku.'-'.$row->store_name;?> </option>
						<?php
